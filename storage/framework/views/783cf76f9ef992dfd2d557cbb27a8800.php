...
<?php if(request()->routeIs('filament.admin.resources.users.view')): ?>
<div class="flex items-center justify-between py-4 px-6 border-b border-gray-300 bg-gray-100 dark:bg-gray-800 mb-4">
    ...
    <?php $__currentLoopData = $flights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="mb-4">
        ...
        <div id="main-content-<?php echo e($item->id); ?>" class="main-content px-2" style="display: none">
            ...
            <div class="flex items-center justify-between py-4 px-6 border-t border-gray-400 bg-gray-300 dark:bg-gray-700  shadow-lg">
                <div class="flex-1 min-w-[180px]">
                    <p class="text-sm text-gray-700 dark:text-gray-400"><strong><?php echo TranslationHelper::translateIfNeeded('Personnel:'); ?> </strong><?php echo e($item->users->name); ?> <?php echo TranslationHelper::translateIfNeeded('(Pilot)'); ?> <?php echo e($item->instructor); ?> <?php echo TranslationHelper::translateIfNeeded('(Instructor)'); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    <?php if(!request()->routeIs('filament.admin.resources.users.view')): ?>
        window.location.href = "<?php echo e(route('filament.admin.resources.users.view', ['tenant' => $teams, 'record' => $personnel])); ?>";
    <?php endif; ?>
</script>
...
</script><?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/flight-personnel.blade.php ENDPATH**/ ?>