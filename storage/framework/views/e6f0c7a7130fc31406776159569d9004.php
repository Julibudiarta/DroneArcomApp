...
<script>
    // Inisialisasi Map
    // var locations = <?php echo json_encode($locations, 15, 512) ?>;
    var datatest = <?php echo json_encode($flightMapst, 15, 512) ?>;

    const map = L.map('map').setView([<?php echo e($latitude ?? 0); ?>, <?php echo e($longitude ?? 0); ?>], 13);

    L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
        maxZoom: 19,
    }).addTo(map);

if(<?php echo e($flighID); ?> != 0){
...
</script><?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/location/maps-view-project.blade.php ENDPATH**/ ?>