        ...
        <div class="flex flex-wrap items-center justify-between border border-gray-300 rounded-lg p-2 bg-black dark:bg-gray-900">
            ...
            <div class="flex flex-wrap gap-2">
                <button id="tab0" class="tab-button active text-white bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded text-sm sm:text-base w-full sm:w-auto">
                    <?php echo TranslationHelper::translateIfNeeded('Flight Document'); ?>
                ...
                <button id="tab3" class="tab-button text-white bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded text-sm sm:text-base w-full sm:w-auto">
                    <?php echo TranslationHelper::translateIfNeeded('Media'); ?>
        ...
        <div class="content">
            ...
            <div id="content0" class="tab-content active">
                ...
                <div class="fixed active-modal inset-0 flex justify-center z-50" style="max-height: 80%">
                    <div class="relative space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-[80%] overflow-y-auto mx-4 md:mx-auto">
                        ...
                        <h2 class="text-center text-lg font-semibold text-gray-900 dark:text-white">
                            <?php echo TranslationHelper::translateIfNeeded('Upload Flight Document'); ?>
                        ...
                        <form id="documentFormFlight" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input id="ownerFlight" type="hidden" name="teams_idFlight" value="<?php echo e(auth()->user()->first()->id); ?>">
                ...
                <div class="mb-2">
                    ...
                    focus:ring-gray-500 dark:focus:ring-gray-300"><?php echo TranslationHelper::translateIfNeeded('Add Flight Document'); ?></button>
                    </div>
                
                    <!--[if BLOCK]><![endif]--><?php if($documentFlight->count() > 0): ?>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $documentFlight; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="content2" class="tab-content">
                ...
                <div class="mb-2">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($incidents->count() > 0): ?>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $incidents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex flex-wrap space-x-4 border border-gray-300 rounded-lg bg-gray-100 dark:bg-gray-800 mx-auto mb-none shadow-lg p-4">
                                ...
                                <div class="flex-1 min-w-[150px] mb-2 border-r border-gray-300 pr-2">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate"><?php echo e($item->location_name); ?></p></p>
                                </div>
            ...
            <div id="content3" class="tab-content">
                ...
                <div class="fixed active-modal media-create inset-0 flex justify-center z-50" style="max-height: 80%">
                    <div class="relative space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-[80%] overflow-y-auto mx-4 md:mx-auto">
                        ...
                        <!-- Judul Modal -->
                        <h2 class="text-center text-lg font-semibold text-gray-900 dark:text-white">
                            <?php echo TranslationHelper::translateIfNeeded('Media Overview'); ?>
                        ...
                        <form id="documentForm" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input id="ownerMedia" type="hidden" name="teams_id" value="<?php echo e(auth()->user()->first()->id); ?>">
                            <input id="mediaFlightID" type="hidden" name="mediaFlightID" value="<?php echo e($id); ?>">
                        
                            <!-- Name Input -->
                            <div>
                                <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Media Title'); ?></label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <!-- Url-->
                                <div>
                                    <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Media URL'); ?></label>
                                ...
                                <!-- Type -->
                                <div>
                                    <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Type Url'); ?></label>
                ...
                <!-- Modal  Edit-->
            <!--[if BLOCK]><![endif]--><?php if($media != null): ?>
                <div class="fixed active-modal media-edit inset-0 flex justify-center z-50" style="max-height: 80%">
                    <div class="relative space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-[80%] overflow-y-auto mx-4 md:mx-auto">
                        ...
                        <!-- Judul Modal -->
                        <h2 class="text-center text-lg font-semibold text-gray-900 dark:text-white">
                            <?php echo TranslationHelper::translateIfNeeded('Edit Media Overview'); ?>
                        ...
                        <form id="documentFormEdit" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input id="idMediaEdit" type="hidden" name="IdMediaEdit" value="<?php echo e($media->id); ?>">
                            <input id="ownerMediaEdit" type="hidden" name="teams_id" value="<?php echo e($media->owner_id); ?>">
                            <input id="mediaFlightIDEdit" type="hidden" name="mediaFlightID" value="<?php echo e($media->fligh_id); ?>">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="mediaTypeEdit" type="text" name="mediaType" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                                        <!--[if BLOCK]><![endif]--><?php if($media->type != null): ?>
                                            <option value="<?php echo e($media->type); ?>" selected >-- <?php echo e($media->type); ?> Url --</option>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500"><?php echo e($media->description ?? ''); ?></textarea>
                            </div>
                            ...
                            <div class="flex justify-end mt-4">
                                <button id="triggerButtonMediaEdit" type="button" class="button" style="font-size: 16px; background-color: #4A5568; color: white; font-weight: bold; padding: 8px 16px; border-radius: 4px; border: none; cursor: pointer;">
                                    <span class="button__text"><?php echo TranslationHelper::translateIfNeeded('Edit'); ?></span>
                                </button>
                            </div>
                        </form>
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
             ...
             <div class="mb-2">
                ...
                hover:bg-gray-600 dark:hover:bg-gray-400 focus:outline-none focus:ring-2 
                focus:ring-gray-500 dark:focus:ring-gray-300"><?php echo TranslationHelper::translateIfNeeded('Add Media'); ?></button>
                </div>
            
                <!--[if BLOCK]><![endif]--><?php if($flighmedia->count() > 0): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $flighmedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <div class="flex flex-wrap space-x-4 border border-gray-300 rounded-lg bg-gray-100 dark:bg-gray-800 mx-auto mb-4 shadow-lg p-4">
                            
                            <!-- column Name -->
                            <div class="flex-1 min-w-[150px] mb-2 border-r border-gray-300 pr-2 overflow-hidden">
                                <p class="text-l text-gray-800 dark:text-gray-200 font-semibold truncate"><?php echo TranslationHelper::translateIfNeeded('Title : '); ?></p>
                                <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate"><?php echo e($item->title); ?></p>
                                <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate"><?php echo e($item->type); ?></p>
                            </div>
                    
                            <!-- Column Number Ref-->
                            <div class="flex-1 min-w-[150px] mb-2 border-r border-gray-300 pr-2">
                                <p class="text-l text-gray-800 dark:text-gray-200 font-semibold"><?php echo TranslationHelper::translateIfNeeded('Notes :'); ?></p>
                                <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate"><?php echo e($item->description); ?></p></p>
                            </div>

                            <!-- Column Modified-->
                            <div class="flex justify-end items-center mb-2 min-w-[150px] border-gray-300 pr-2">   
                                <button 
                                    id="ViewButton-<?php echo e($item->id); ?>" 
                                    type="button" 
                                    class="px-4 py-2 bg-gray-700 text-white font-semibold rounded-lg 
                                        ...
                                        focus:ring-gray-500 dark:focus:ring-gray-300"
                                    onclick="window.open('<?php echo e($item->url); ?>', '_blank')"
                                >
                                    <?php echo TranslationHelper::translateIfNeeded('View'); ?>

                                </button>
                            </div>
                            <div class="flex justify-end items-center mb-2 min-w-[150px] border-gray-300 pr-2">

                                <button id="valueButton-<?php echo e($item->id); ?>" type="button" class="px-4 py-2 bg-gray-700 text-white font-semibold rounded-lg 
                                hover:bg-gray-600 dark:hover:bg-gray-400 focus:outline-none focus:ring-2 
                                focus:ring-gray-500 dark:focus:ring-gray-300" value="<?php echo e($item->id); ?>" onclick="openModalMediaEdit(<?php echo e($item->id); ?>)">
                                <?php echo TranslationHelper::translateIfNeeded('Edit'); ?>
...
<script>
    ...
    function openModalMediaEdit(itemId) {
        ...
        console.log(buttonValue);
            $.ajax({
            url: '<?php echo e(route("edit.media.flight")); ?>',
            type: 'POST',
            data: {
...
<script>
    ...
    $(document).ready(function() {
        $('#triggerButtonMediaEdit').click(function() {
            ...
            formDataMediaEdit.append('_token', '<?php echo e(csrf_token()); ?>'); // CSRF token
            ...
            if(name == null){
                ...
                $.ajax({
                    url: '<?php echo e(route('create.media.flight.record')); ?>',
                    type: 'POST',
    ...
    $(document).ready(function() {
        $('#triggerButtonMedia').click(function() {
            ...
            formDataMedia.append('_token', '<?php echo e(csrf_token()); ?>'); // CSRF token
            ...
            if(name == null){
                ...
                $.ajax({
                    url: '<?php echo e(route('create.media.flight')); ?>',
                    type: 'POST',
                    data: formDataMedia,
                    contentType: false,
                    processData: false,
    ...
    $(document).ready(function() {
        $('#triggerButtonFlight').click(function() {
            ...
            formDataFlight.append('_token', '<?php echo e(csrf_token()); ?>'); // CSRF token
            ...
            if(name == null){
                ...
                $.ajax({
                    url: '<?php echo e(route('create.document.flight')); ?>',
                    type: 'POST',
                    data: formDataFlight,
                    contentType: false,
                    processData: false,
...
<?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/tabViewResorce/flight-tab.blade.php ENDPATH**/ ?>