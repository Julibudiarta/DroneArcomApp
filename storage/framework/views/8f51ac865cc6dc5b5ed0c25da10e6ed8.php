...
$year = session('tahun', now()->year);
    $locationId = session('location_id');
        $tenant_id = Auth()->user()->teams()->first()->id;
            $flights = App\Models\fligh::where('teams_id', $tenant_id)->where('location_id', $locationId)
...
<?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/chartjs/location-statistik.blade.php ENDPATH**/ ?>