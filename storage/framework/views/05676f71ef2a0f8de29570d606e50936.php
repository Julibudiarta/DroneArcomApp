...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-breezy::components.grid-section','data' => ['title' => ''.e($translatedTitle).'','description' => ''.e($translatedDescription).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($translatedTitle).'','description' => ''.e($translatedDescription).'']); ?>
...
<?php $component->withAttributes(['type' => 'submit','form' => 'submit','class' => 'align-right']); ?>
                    <?php echo TranslationHelper::translateIfNeeded('Update'); ?>
...
<?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/vendor/filament-breezy/livewire/more-info.blade.php ENDPATH**/ ?>