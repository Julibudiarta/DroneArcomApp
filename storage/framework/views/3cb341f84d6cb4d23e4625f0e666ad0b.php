...
$year = session('tahun', now()->year);
        $id = $getRecord()->id;
            $flights = App\Models\fligh::where('teams_id', $id)
...
<head>
    ...
    <div class="flex justify-center items-center">    
        <div class="rounded-lg shadow-lg p-4 w-full max-w-sm">
            <p class="text-sm font-semibold text-center text-gray-800 dark:text-gray-100">Flight Team Statistik in <?php echo e($year); ?></p>
            <canvas id="dualAxisChart" class="w-full h-auto"></canvas>
            <p class="text-sm font-semibold text-center text-gray-700 dark:text-gray-100 mb-2"><?php echo e($totalFlightsPerMonth); ?> Flights / <?php echo e($formattedTotalDuration); ?> Hours in <?php echo e($year); ?></p>
...
<script>
    ...
    chartRender(); 
</script><?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/chartjs/team-statistik.blade.php ENDPATH**/ ?>