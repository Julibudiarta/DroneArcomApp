  ...
  <!-- Tombol untuk Membuka Modal -->
    <button style="font-size: 12px; background-color: #4A5568; color: white; font-weight: bold; padding: 4px 8px; border-radius: 4px; border: none; cursor: pointer;" onclick="openModalDrone()" type="button">
        <span style="color: inherit; text-decoration: none;">
            <?php echo TranslationHelper::translateIfNeeded('Add New Drone'); ?>
    ...
    <div class="fixed drone active inset-0 flex justify-center z-50" style="max-height: 80%">
        <div class="relative space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-[80%] overflow-y-auto mx-4 md:mx-auto">
            ...
            <h2 class="text-center text-lg font-semibold text-gray-900 dark:text-white">
                <?php echo TranslationHelper::translateIfNeeded('Create Drone'); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- Model Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Model'); ?></label>
                    ...
                    <!-- Brand Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Brand'); ?></label>
                    ...
                    <!-- Type Input -->
                    <div>
                        <label for="type" class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Type'); ?></label>
                        <select id="typedrone" name="type" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('Select Type'); ?></option>
                    ...
                    <!-- Serial P Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Serial Printed'); ?></label>
                    ...
                    <!-- Serial I Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Serial Internal'); ?></label>
                    ...
                    <!-- Flight Count Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Flight Count'); ?></label>
                    ...
                    <!-- Remote C Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Remote Controller'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Remote Controller2'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Status'); ?></label>
                ...
                <!--Legal ID-->
                <div>
                    <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Legal ID'); ?></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Inventory/Asset'); ?></label>
                    ...
                    <!-- drone Geometry -->
                    <div>
                        <label for="geometry" class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Drone Geometry'); ?></label>
                        <select id="geometrydrone" name="geometry" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('Select Geometry'); ?></option>
                    ...
                    <!-- Users Select -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Owner'); ?></label>
                        <select id="users_iddrone" name="users_id" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('Select Users'); ?></option>
                            <!--[if BLOCK]><![endif]--><?php if($users === null): ?>
                                <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('No Users Foundr'); ?></option>
                            <?php else: ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = App\Models\User::whereHas('teams', function ($query) {
                                        $query->where('teams.id', auth()->user()->teams()->first()->id);
                                    })->pluck('name', 'id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Firmware Version'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Hardware Version'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Propulsion Version'); ?></label>
                        <select id="propulsion_vdrone" name="propulsion_vdrone" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('Select an propulsion version'); ?></option>
                    ...
                    <!-- Color Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Color'); ?></label>
                    ...
                    <!-- Remote Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Remote ID'); ?></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Conn Card Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Connection Card'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Initial Flight'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Initial Flight Time'); ?></label>
                        <input 
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Max Flight Time'); ?></label>
                        <input 
                    ...
                    <!-- Description Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Description'); ?></label>
...
<script>
    function createDrone() {
        ...
        if (nameValue.trim() === '') {
            ...
            // Send data via AJAX
            $.ajax({
                url: '<?php echo e(route('create-drone')); ?>',
                type: 'POST',
                data: {
...
<?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/button-drone.blade.php ENDPATH**/ ?>