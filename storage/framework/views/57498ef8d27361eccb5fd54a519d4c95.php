...
<script>
    // Inisialisasi Map
    const map = L.map('map').setView([<?php echo e($latitude); ?>, <?php echo e($longitude); ?>], 13);  // Set view berdasarkan data dari database
    ...
    //marker di 1 lokasi
    L.marker([<?php echo e($latitude); ?>, <?php echo e($longitude); ?>]).addTo(map)
    .bindPopup(`
        <section class="p-2 bg-white dark:bg-gray-800 shadow-md rounded-lg max-w-xs mx-auto">
            <header class="font-semibold text-sm text-gray-800 dark:text-gray-100">
                <strong>Lokasi: </strong><span style="color:blue;"><?php echo e($address); ?></span>
            </header>
            <section class="font-semibold text-sm text-gray-800 dark:text-gray-100 mt-1">
                <strong>Projects: </strong><span class="text-gray-700 dark:text-gray-300"><?php echo e($case); ?></span>
            </section>
            <footer class="mt-2">
                <a href="https://www.google.com/maps?q=<?php echo e($latitude); ?>,<?php echo e($longitude); ?>" target="_blank">
                    <button style="
                        display: block; 
                        width: 100%; 
...
</script><?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/location/maps-view-location.blade.php ENDPATH**/ ?>