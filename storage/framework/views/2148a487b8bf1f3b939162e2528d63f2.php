  ...
  <!-- Tombol untuk Membuka Modal -->
    <button style="font-size: 12px; background-color: #4A5568; color: white; font-weight: bold; padding: 4px 8px; border-radius: 4px; border: none; cursor: pointer;" onclick="openModalBattrei()" type="button">
        <span style="color: inherit; text-decoration: none;">
            <?php echo TranslationHelper::translateIfNeeded('Add New Battery'); ?>
    ...
    <div class="fixed battrei active inset-0 flex justify-center z-50" style="max-height: 80%">
        <div class="relative space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-[80%] overflow-y-auto mx-4 md:mx-auto">
            ...
            <h2 class="text-center text-lg font-semibold text-gray-900 dark:text-white">
                <?php echo TranslationHelper::translateIfNeeded('Create Battery'); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Asset/Inventory'); ?></label>
                    ...
                    <!-- Serial P Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Serial P'); ?></label>
                    ...
                    <!-- Serial I Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Serial I'); ?></label>
                    ...
                    <!-- Cell Count Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Cell Count'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Nominal Voltage'); ?></label>
                    ...
                    <!-- Capacity Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Capacity'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Initial Cycle Count'); ?></label>
                    ...
                    <!-- Life Span Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Life Span'); ?></label>
                    ...
                    <!-- For Drone Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('For Drone (Optional)'); ?></label>
                        <select id="for_dronebattrei" name="for_drone" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('Select an Drone'); ?></option>
                            <!--[if BLOCK]><![endif]--><?php if(App\Models\Drone::where('teams_id', auth()->user()->teams()->first()->id)->count() == null): ?>
                                <option value="" disabled><?php echo TranslationHelper::translateIfNeeded('No Drones Found'); ?></option>
                            <?php else: ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = App\Models\Drone::where('teams_id', auth()->user()->teams()->first()->id)->pluck('name', 'id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!-- Purchase Date Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Purchase Date'); ?></label>
                    ...
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Insurable Value'); ?></label>
                    ...
                    <!-- Weight Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Weight'); ?></label>
                    ...
                    <div>
                        ...
                        <select id="users_idbattrei" name="users_id" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('Select an Users'); ?></option>
                            <!--[if BLOCK]><![endif]--><?php if($users === null): ?>
                                <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('No Users Found'); ?></option>
                            <?php else: ?>
                    ...
                    <!-- Is Loaner Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Is Loaner'); ?></label>
...
<script>
    function createBattrei() {
        ...
        if (nameValue.trim() === '') {
            ...
            // Send data via AJAX
            $.ajax({
                url: '<?php echo e(route('create-battrei')); ?>',
                type: 'POST',
                data: {
...
<?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/button-battery.blade.php ENDPATH**/ ?>