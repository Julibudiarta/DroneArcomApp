  ...
  <!-- Tombol untuk Membuka Modal -->
    <button style="font-size: 12px; background-color: #4A5568; color: white; font-weight: bold; padding: 4px 8px; border-radius: 4px; border: none; cursor: pointer;" onclick="openModalLocation()" type="button">
        <span style="color: inherit; text-decoration: none;">
            <?php echo TranslationHelper::translateIfNeeded('Add New Location'); ?>
    ...
    <div class="fixed location active inset-0 flex justify-center z-50" style="max-height: 80%">
        <div class="relative space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-[80%] overflow-y-auto mx-4 md:mx-auto">
            ...
            <h2 class="text-center text-lg font-semibold text-gray-900 dark:text-white">
                <?php echo TranslationHelper::translateIfNeeded('Create Location'); ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <!-- Customer Select -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Customer'); ?></label>
                        <select id="customers_id" name="customers_id" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('Select an Customer'); ?></option>
                            <!--[if BLOCK]><![endif]--><?php if(App\Models\customer::where('teams_id', auth()->user()->teams()->first()->id)->count() == null): ?>
                                <option value="" disabled><?php echo TranslationHelper::translateIfNeeded('No Customer Available'); ?></option>
                            <?php else: ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = App\Models\customer::where('teams_id', auth()->user()->teams()->first()->id)->pluck('name', 'id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!-- Project Select -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Project'); ?></label>
                        <select id="projects_id" name="projects_id" class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            <option value="" disabled selected><?php echo TranslationHelper::translateIfNeeded('Select an projects'); ?></option>
                            <!--[if BLOCK]><![endif]--><?php if(App\Models\projects::where('teams_id', auth()->user()->teams()->first()->id)->count() == null): ?>
                                <option value="" disabled><?php echo TranslationHelper::translateIfNeeded('No Project Found'); ?></option>
                            <?php else: ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = App\Models\projects::where('teams_id', auth()->user()->teams()->first()->id)->pluck('case', 'id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>"><?php echo e($name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </select>
                    ...
                    <!-- Address Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Address'); ?></label>
                    ...
                    <!-- Country Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Country'); ?></label>
                    ...
                    <!-- City Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('City'); ?></label>
                    ...
                    <!-- State Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('State'); ?></label>
                    ...
                    <!-- Postal Code Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Postal Code'); ?></label>
                    ...
                    <!-- Latitude Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Latitude'); ?></label>
                    ...
                    <!-- Longitude Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Longitude'); ?></label>
                    ...
                    <!-- Altitude Input -->
                    <div>
                        <label class="block text-gray-700 dark:text-gray-300"><?php echo TranslationHelper::translateIfNeeded('Altitude'); ?></label>
...
<script>
 function createLocation() {
    ...
    if (nameValue.trim() === '') {
        ...
        $.ajax({
            url: '<?php echo e(route('create-Location')); ?>',
            type: 'POST',
            data: {
...
<?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/button-location.blade.php ENDPATH**/ ?>