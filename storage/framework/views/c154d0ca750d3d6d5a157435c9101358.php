...
<?php if(request()->routeIs('filament.admin.resources.projects.view')): ?>
...
<script>
    <?php if(!request()->routeIs('filament.admin.resources.projects.view')): ?>
        window.location.href = "<?php echo e(route('filament.admin.resources.projects.view', ['tenant' => $teams, 'record' => $projects])); ?>";
    <?php endif; ?>
</script>
...
</script><?php /**PATH C:\laragon\www\drone-app-arcom\resources\views/component/flight-project.blade.php ENDPATH**/ ?>